...
<div class="com-container">
    ...
    <div class="menu-header">
        <h2 class="d-flex align-items-center">💊 Gestión</h2>
    </div>
    
    <nav class="com-nav-items">
        <a href="{{ route('medicamentos.index') }}" class="com-nav">Gestión de Lotes y Caducidad</a>
        <a href="{{ route('medicamentos.index') }}" class="com-nav">Control de laboratorio</a>
        <a href="{{ route('medicamentos.index') }}" class="com-nav">Stock</a>
    </nav>
...
<div class="row g-4 mt-4" id="cards-container">
    <div class="col-md-4">
        <div class="card p-3 text-center">
            <div class="display-4 mb-3">🖊️🖇️</div>
            <h4 class="card-title">sumininstros de papeleria:</h4>
    ...
    <div class="col-md-4">
        <div class="card p-3 text-center">
            ...
            <p class="card-text px-3">Equipos,Muebles,sillas</p>
...
<div class="col-md-4">
        <div class="card p-3 text-center">
            ...
            <h4 class="card-title">Unimforrmes</h4>
            <p class="card-text px-3">Tallas,Tipos,Color...</p>
            <button onclick="showDetails('piso2')" class="btn btn-primary">Ingresar</button>
        </div>
    </div>
