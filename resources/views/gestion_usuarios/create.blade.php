    ...
    <div class="container-fluid d-flex p-0">
        ...
        <main class="content">
            ...
            <div class="card">
                ...
                <p class="text-muted">Crea una nueva cuenta de usuario y define su rol, departamento/área y permisos de acceso.</p>
                ...
                <form method="POST" action="{{ route('users.store') }}" class="mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Ej: Kevin, Jose Diaz..." required>
                        </div>
                    </div>
                    ...
                    <div id="rol-dependencias-container" class="mb-3">
                        ...
                        <div id="departamentos-jefe-container" style="display: none;">
                            ...
                            <div class="mt-4">
                                <label class="form-label fw-bold text-dark">Asignar subordinados libres (Opcional)</label>
                                <p class="text-muted small">Selecciona los empleados o practicantes que pertenecerán a este nuevo jefe.</p>
                                <div class="row bg-white p-3 rounded border border-light-subtle mb-3">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="subordinados[]" value="{{ $sub->id }}" id="sub_{{ $sub->id }}"
                                                    {{ is_array(old('subordinados')) && in_array($sub->id, old('subordinados')) ? 'checked' : '' }}>
                                    ...
                                    @empty
                                        <div class="col-12 text-muted small">No hay empleados/practicantes sin jefe asignado.</div>
                                    @endforelse
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="area_id" name="area_id" onchange="updateJefeResponsable()">
                                    ...
                                    @foreach($areas as $area)
                                        <option value="{{ $area->id }}" data-nombre="{{ $area->nombre }}" {{ old('area_id') == $area->id ? 'selected' : '' }}>
                                            {{ $area->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control" id="password" name="password" placeholder="Ingresa la contraseña" required style="padding-right: 40px;">
                                ...
                                <div class="sub-perms-wrapper-row" style="display: flex; align-items: center; justify-content: space-between; padding: 8px 16px; border-bottom: 1px solid #f1f5f9; flex-wrap: wrap; gap: 10px;">
                                    <div class="form-check" style="margin: 0; min-width: 220px;">
                                        <input class="form-check-input module-checkbox" type="checkbox" name="permisos[]" value="{{ $key }}" id="perm_{{ $key }}" 
                                            {{ is_array(old('permisos')) && in_array($key, old('permisos')) ? 'checked' : '' }} onchange="toggleSubPerms('{{ $key }}')">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <button type="submit" class="btn btn-primary px-4 py-2" style="font-weight: 600;">Guardar Usuario</button>
                    </div>
                </form>
            </div>
        </main>
